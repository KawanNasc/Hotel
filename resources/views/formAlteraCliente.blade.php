...
<form class="row g-3" method="post" action="{{ route('alterarClienteBanco', $registrosClientes->id) }}">
  @method('PUT')
  @csrf
  <div class="col-md-12">
  ...
  <div class="col-3">
    ...
    <input type="text" class="form-control" name="fone" id="inputFone" value="{{ old('nome', $registrosClientes->fone) }}" placeholder="11 1111-1111">
    @error('fone')
